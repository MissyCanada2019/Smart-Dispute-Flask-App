#!/usr/bin/env python3
"""
Debug script for the enhanced health check functionality
"""
...
def debug_health_check():
    """Debug the enhanced health check functionality"""
    print("\n🔍 Debugging enhanced health check functionality...")
    ...
    with app.app_context():
        ...
        # Test database check
        try:
            db_status, db_message = HealthCheck.check_database()
            print(f"  Database check: {db_status} - {db_message}")
        except Exception as e:
        ...
        try:
            ...
            print(f"  Overall health status check: FAILED - {e}")
